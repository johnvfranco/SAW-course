...
class lab5B extends JFrame implements ActionListener {
   ...
   public lab5B (lab5 pnt) {
      super("Equivalence Checking");
      ...
      try {
         fpath = (new java.io.File(".").getCanonicalPath())+"/src/lab5B/";
      ...
      rs.add(title = new JLabel("Lesson 5.2                      ", JLabel.CENTER));
      ...
      p.setBackground(bkgd);
      p.add(lbl = new JLabel("  Equivalence Checking"));
      lbl.setFont(fnt);
      q.add(p);
      xy.add("Center", q);
