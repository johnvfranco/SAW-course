...
class lab3D extends JFrame implements ActionListener {
   ...
   public lab3D (lab3 pnt) {
      ...
      try {
         fpath = (new java.io.File(".").getCanonicalPath())+"/src/lab3D/";
      ...
      rs.add(title = new JLabel("Lesson 3.4                      ", JLabel.CENTER));
