...
class lab3 extends JFrame implements ActionListener {
   ...
   public lab3 (aFrame pnt) {
      ...
      rs.add(title = new JLabel("Writing Specifications                ", JLabel.CENTER));
      ...
      p.setBackground(bkgd);
      p.add(lbl = new JLabel("  Specification from HR to Cryptol: ZUC", JLabel.LEFT));
      lbl.setFont(fnt);
      q.add(p);
      ...
      p = new JPanel(new FlowLayout(FlowLayout.LEFT));
      p.setBackground(bkgd);
      p.add(lbl = new JLabel("  Specification of DES", JLabel.LEFT));
      lbl.setFont(fnt);
      q.add(p);
   ...
   public void actionPerformed (ActionEvent evt) {
      ...
      else if (evt.getSource() == d[1]) getDoc(fpath+"/lab3A/synopsis.pdf");
      else if (evt.getSource() == d[2]) getDoc(fpath+"/lab3B/synopsis.pdf");
      else if (evt.getSource() == d[3]) getDoc(fpath+"/lab3C/synopsis.pdf");
      else if (evt.getSource() == d[4]) getDoc(fpath+"/lab3D/synopsis.pdf");
      else if (evt.getSource() == d[5]) getDoc(fpath+"/lab3E/synopsis.pdf");
   }
