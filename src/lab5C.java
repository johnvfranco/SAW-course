...
class lab5C extends JFrame implements ActionListener {
   ...
   public lab5C (lab5 pnt) {
      ...
      rs.add(title = new JLabel("Lesson 5.3                      ", JLabel.CENTER));
      ...
      p.setBackground(bkgd);
      p.add(lbl = new JLabel("  Equivalence across languages"));
      lbl.setFont(fnt);
      q.add(p);
      xy.add("Center", q);
         ...
         try {
            ...
            javax.swing.filechooser.FileFilter filter =
               new FileNameExtensionFilter(
						 "Editable files",
                   new String[] {"txt","cry","tex","saw","c","cc","py","h","Makefile","ll","java"});
