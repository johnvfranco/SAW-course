...
class lab2A extends JFrame implements ActionListener {
   ...
   public lab2A (lab2 pnt) {
      ...
      try {
         fpath = (new java.io.File(".").getCanonicalPath())+"/src/lab2A/";
      ...
      rs.add(title = new JLabel("Lesson 2.1                      ", JLabel.CENTER));
      ...
      p.setBackground(bkgd);
      p.add(lbl = new JLabel("  Commands & built-ins"));
      lbl.setFont(fnt);
      q.add(p);
      xy.add("Center", q);
