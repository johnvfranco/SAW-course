...
class lab5A extends JFrame implements ActionListener {
   ...
   public lab5A (lab5 pnt) {
      ...
      try {
         fpath = (new java.io.File(".").getCanonicalPath())+"/src/lab5A/";
      } catch (Exception e) {
      ...
      rs.add(title = new JLabel("Lesson 5.1                      ", JLabel.CENTER));
         ...
         try {
            ...
            javax.swing.filechooser.FileFilter filter =
               new FileNameExtensionFilter("Editable files",
                                           new String[] {"txt", "cry", "tex", "saw", "c","h","Makefile","ll"});
