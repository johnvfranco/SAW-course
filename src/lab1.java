...
class lab1 extends JFrame implements ActionListener {
   ...
   public lab1 (aFrame pnt) {
      ...
      rs.add(title = new JLabel("Math Logic                      ", JLabel.CENTER));
      ...
      p.setBackground(bkgd);
      p.add(lbl = new JLabel("  What is Math Logic?"));
      lbl.setFont(fnt);
      q.add(p);
      p = new JPanel(new FlowLayout(FlowLayout.LEFT));
      p.setBackground(bkgd);
      p.add(lbl = new JLabel("  Why is it important?"));
      lbl.setFont(fnt);
      q.add(p);
      xy.add("Center", q);
