...
class lab7E extends JFrame implements ActionListener {
   ...
   public lab7E (lab7 pnt) {
      ...
      try {
         fpath = (new java.io.File(".").getCanonicalPath())+"/src/lab7E/";
      } catch (Exception e) {
      ...
      rs.add(title = new JLabel("Lesson 6.5                      ", JLabel.CENTER));
