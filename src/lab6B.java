...
class lab6B extends JFrame implements ActionListener {
   ...
   public lab6B (lab6 pnt) {
      ...
      try {
         fpath = (new java.io.File(".").getCanonicalPath())+"/src/lab6B/";
      } catch (Exception e) {
      ...
      p.setBackground(bkgd);
      p.add(lbl = new JLabel("  Examples in Java"));
      lbl.setFont(fnt);
      q.add(p);
      xy.add("Center", q);
