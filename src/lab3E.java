...
class lab3E extends JFrame implements ActionListener {
   ...
   public lab3E (lab3 pnt) {
      ...
      try {
         fpath = (new java.io.File(".").getCanonicalPath())+"/src/lab3E/";
      ...
      rs.add(title = new JLabel("Lesson 3.5                      ", JLabel.CENTER));
      ...
      p.setBackground(bkgd);
      p.add(lbl = new JLabel("  Bounded Model Checking "));
      lbl.setFont(fnt);
      q.add(p);
      xy.add("Center", q);
