...
class lab2B extends JFrame implements ActionListener {
   ...
   public lab2B (lab2 pnt) {
      ...
      try {
         fpath = (new java.io.File(".").getCanonicalPath())+"/src/lab2B/";
      ...
      rs.add(title = new JLabel("Lesson 2.2                      ", JLabel.CENTER));
      ...
      p.setBackground(bkgd);
      p.add(lbl = new JLabel("  Cryptol typing"));
      lbl.setFont(fnt);
      q.add(p);
      xy.add("Center", q);
