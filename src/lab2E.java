...
class lab2E extends JFrame implements ActionListener {
   ...
   public lab2E (lab2 pnt) {
      ...
      try {
         fpath = (new java.io.File(".").getCanonicalPath())+"/src/lab2E/";
      ...
      rs.add(title = new JLabel("Lesson 2.5                      ", JLabel.CENTER));
      ...
      p.setBackground(bkgd);
      p.add(lbl = new JLabel("  Cryptol functions"));
      lbl.setFont(fnt);
      q.add(p);
      xy.add("Center", q);
