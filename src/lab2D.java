...
class lab2D extends JFrame implements ActionListener {
   ...
   public lab2D (lab2 pnt) {
      ...
      try {
         fpath = (new java.io.File(".").getCanonicalPath())+"/src/lab2D/";
      ...
      rs.add(title = new JLabel("Lesson 2.4                      ", JLabel.CENTER));
      ...
      p.setBackground(bkgd);
      p.add(lbl = new JLabel("  Cryptol comprehensions"));
      lbl.setFont(fnt);
      q.add(p);
      xy.add("Center", q);
