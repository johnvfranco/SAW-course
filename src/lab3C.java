...
class lab3C extends JFrame implements ActionListener {
   ...
   public lab3C (lab3 pnt) {
      ...
      try {
         fpath = (new java.io.File(".").getCanonicalPath())+"/src/lab3C/";
      ...
      rs.add(title = new JLabel("Lesson 3.3                      ", JLabel.CENTER));
